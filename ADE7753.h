...
#define DOUT_MOSI_SPI_7753_MCU   PORTD.4
#define DIN_MISO_SPI_7753_MCU    PIND.5
#define DOUT_CLK_SPI_7753_MCU   PORTD.7
#define DOUT_CS_SPI_7753_1_MCU   PORTD.6

#define DOUT_CS_SPI_7753_2_MCU PORTB.0
#define DOUT_CS_SPI_7753_3_MCU PORTB.0

#define SPI_SCK_HIGHT   DOUT_CLK_SPI_7753_MCU = 0
#define SPI_SCK_LOW   DOUT_CLK_SPI_7753_MCU = 1

#define SPI_MOSI_HIGHT  DOUT_MOSI_SPI_7753_MCU = 0
...
#define PHASE_1_ON  DOUT_CS_SPI_7753_1_MCU = 1
#define PHASE_1_OFF DOUT_CS_SPI_7753_1_MCU = 0
#define PHASE_2_ON  DOUT_CS_SPI_7753_2_MCU = 1
#define PHASE_2_OFF DOUT_CS_SPI_7753_2_MCU = 0
